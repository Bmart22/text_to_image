...
#    print(image_dict["image_id"].size)
#    print(im_sizes.shape)
#
    # For every image
...
def gen_style_vec( image_ind ):
    # Load the mapping between numerical part ids and string part names
#    bird_part_dict = pd.read_csv("CUB_200_2011/CUB_200_2011/parts/parts.txt", sep = " ", header=None, names=["part_id","part_name"])
...
#    desired_sizes = image_sizes[image_ind]
...
#    coordinates = np.ones( (style_vecs.shape[1],) )
#    print(np.arange(style_vecs.shape[1])[:2])

#    style_vecs[:,:2] = style_vecs[:,:2] / desired_sizes
